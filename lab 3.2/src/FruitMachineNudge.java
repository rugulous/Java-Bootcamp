...
public class FruitMachineNudge {
	...
	public static void main(String[] args) {
		...
		while(playing) {
			...
			System.out.println("");
			System.out.println("Would you like to nudge fruit 1? [Y / N]");
			if(input.next().toLowerCase().charAt(0) == 'y') {
				fruitOne = resolveFruit(fruit1Int + (int)(Math.random() * 6) + 1);
				System.out.println("Fruit one is now..." + fruitOne);
			}
			
			System.out.println("Would you like to nudge fruit 2? [Y / N]");
			if(input.next().toLowerCase().charAt(0) == 'y') {
				fruitTwo = resolveFruit(fruit2Int + (int)(Math.random() * 6) + 1);
				System.out.println("Fruit two is now..." + fruitTwo);
			}
			
			System.out.println("Would you like to nudge fruit 3? [Y / N]");
			if(input.next().toLowerCase().charAt(0) == 'y') {
				fruitThree = resolveFruit(fruit3Int + (int)(Math.random() * 6) + 1);
				System.out.println("Fruit three is now..." + fruitThree);
			}
